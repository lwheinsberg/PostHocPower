...
ggplot(data=power.table, aes(x=beta, y=power)) + geom_line() +  xlab("Effect Size") + ylab("Power") + ggtitle("Predicted statistical power curve for experiments at Universities A and B.")
```
